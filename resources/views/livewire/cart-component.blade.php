					...
					<ul class="products-cart">
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ asset('')}}"{{ asset('assets/images/products/digital_18.jpg')}}" alt=""></figure>
							</div>
						...
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ asset('')}}"{{ asset('assets/images/products/digital_20.jpg')}}" alt=""></figure>
							</div>
							<div class="product-name">
								<a class="link-to-product" href="#">Radiant-360 R6 Wireless Omnidirectional Speaker [White]</a>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
										<figure><img src="{{ asset('')}}"{{ asset('assets/images/products/digital_04.jpg')}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
